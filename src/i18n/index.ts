...
const en: Dict = {
  ...
  helpDriversWin: "**Windows** does not always bring the driver itself. Windows 7 never does, and 10 and 11 are inconsistent: sometimes a working driver arrives through Windows Update, sometimes a stale one, sometimes none. Two signs that it is missing: Device Manager lists the cable under 'Other devices' with a warning icon, or the port picker here offers only the motherboard's built-in COM1. Install the CH340 driver (CH341SER) from the chip maker WCH: <a href=\"https://www.wch-ic.com/downloads/CH341SER_EXE.html\" target=\"_blank\" rel=\"nofollow noopener\">download CH341SER</a>.",
...
const pl: Dict = {
  ...
  helpDriversWin: "**Windows** nie zawsze przynosi sterownik sam. Windows 7 nie robi tego nigdy, a 10 i 11 bywają nieprzewidywalne: czasem przez Windows Update przychodzi działający sterownik, czasem przestarzały, czasem żaden. Dwa znaki, że go brakuje: w Menedżerze urządzeń kabel siedzi w „Inne urządzenia\" z wykrzyknikiem albo lista portów proponuje wyłącznie wbudowany COM1 płyty głównej. Zainstaluj sterownik CH340 (CH341SER) od producenta układu, firmy WCH: <a href=\"https://www.wch-ic.com/downloads/CH341SER_EXE.html\" target=\"_blank\" rel=\"nofollow noopener\">pobierz CH341SER</a>.",
...
const de: Dict = {
  ...
  helpDriversWin: "**Windows** bringt den Treiber nicht immer mit. Windows 7 nie, 10 und 11 sind unbeständig: mal kommt über Windows Update ein funktionierender Treiber, mal ein veralteter, mal keiner. Zwei Anzeichen, dass er fehlt: Das Kabel steht im Geräte-Manager unter „Andere Geräte\" mit Warnzeichen, oder die Portauswahl bietet nur den eingebauten COM1 des Mainboards. Installiere den CH340-Treiber (CH341SER) des Chipherstellers WCH: <a href=\"https://www.wch-ic.com/downloads/CH341SER_EXE.html\" target=\"_blank\" rel=\"nofollow noopener\">CH341SER herunterladen</a>.",
...
const cs: Dict = {
  ...
  helpDriversWin: "**Windows** ovladač vždy nepřinese. Windows 7 nikdy, 10 a 11 jsou nevyzpytatelné: někdy přes Windows Update dorazí funkční ovladač, jindy zastaralý, jindy žádný. Dvě znamení, že chybí: kabel je ve Správci zařízení v „Jiná zařízení\" s vykřičníkem, nebo nabídka portů obsahuje jen vestavěný COM1 základní desky. Nainstaluj ovladač CH340 (CH341SER) od výrobce čipu WCH: <a href=\"https://www.wch-ic.com/downloads/CH341SER_EXE.html\" target=\"_blank\" rel=\"nofollow noopener\">stáhnout CH341SER</a>.",
